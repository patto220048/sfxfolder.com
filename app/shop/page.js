...
export default async function ShopPage() {
  ...
  const { data: packs, error } = await supabaseAdmin
    .from("sound_packs")
    .select("id, name, slug, description, short_description, price, original_price, cover_image, is_featured, item_count, total_size, purchase_count, created_at, average_rating, review_count, view_count")
    .eq("status", "published")
